        ...
        <div className="flex flex-col gap-2 mt-3">
          {classification && type !== 'Alimento Úmido' && type !== 'Snack' && category !== 'Peixes' && (
            <div className="flex items-center gap-2">
              <div className={`${getClassificationColor(classification)} px-3 py-1.5 text-xs font-semibold rounded-md`}>
                <span className="font-bold font-barlow-condensed text-gray-300">Linha {classification}</span>
              </div>
